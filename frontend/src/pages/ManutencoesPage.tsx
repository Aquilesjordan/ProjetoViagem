...
const columns: GridColDef<Manutencao>[] = [
  ...
  { field: 'tipoServico', headerName: 'Tipo de serviço', minWidth: 180, flex: 1 },
  {
    ...
    minWidth: 130,
    flex: 1,
    valueGetter: (_value, row) => formatDate(row.dataInicio),
  },
  {
    ...
    minWidth: 150,
    flex: 1,
    valueGetter: (_value, row) => formatDate(row.dataFinalizacao),
  },
  {
    field: 'custoEstimado',
    headerName: 'Custo',
    minWidth: 120,
    flex: 1,
    valueGetter: (_value, row) => formatCurrency(row.custoEstimado ?? 0),
  },
